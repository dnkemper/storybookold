import ResearchCard from './Card.vue'
import ResearchGrid from '../grid/Grid.vue'
import ResearchGridItem from '../grid/GridItem.vue'
import card_image from '../../assets/images/viewbook/sections/122.jpg'
import person_image from '../../assets/images/viewbook/sections/person-one.svg'
...
Default.args = {
  ...
  meta: '',
  default:
    'For decades, Washu has been a gathering place for artists, creating a cultural hub that’s more accessible than any major city. ',
  url: 'https://artsci.wustl.edu',
...
ImageUsingIcon.args = {
  ...
  title: '24hour-phone',
  media:
    '<img icon="24hour-phone" variant="two-color" src="https://icons.brand.wustl.edu/brand-icons/megaphone-bullhorn-two-color.png" alt="24hour-phone" loading="lazy" class="two-color">',
  url: 'https://wustl.edu',
  default: '',
}
...
PersonProfile.args = {
  ...Default.args,
  media: '<img src="' + person_image + '" alt="not-found">',
  orientation: 'right',
  media_size: 'small',
  media_shape: 'circle',
  media_border: true,
...
const GridTemplate = (args) => ({
  // Components used in your story `template` are defined in the `components` object
  components: { ResearchGrid, ResearchGridItem, ResearchCard },
  // The story's `args` need to be mapped into the template through the `setup()` method
  setup() {
    return { args }
  },
