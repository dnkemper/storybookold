...
const Template = (args) => ({
  ...
  components: { ResearchGrid, ResearchGridItem, ResearchCallout, ResearchFigure, Media},
  ...
  template: `
    <research-grid :type="args.grid_type">
      <research-grid-item v-for="item in args.records" :key="item">
