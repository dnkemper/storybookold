  ...
  parameters: {
    ...
    backgrounds: {
      ...
      values: [
        ...
        {
          name: 'red - brain pattern',
          value: 'url(../src/assets/images/brain-pattern-reversed.svg) #d01c29',
        },
        {
          name: 'red - community pattern',
          value: 'url(../src/assets/images/community-pattern--white.png) #d01c29',
        },
        {
          name: 'red - particle pattern',
          value: 'url(../src/assets/images/particle-pattern.png) #d01c29',
        },
        {
          name: 'gray',
          value: '#f3f3f3',
        ...
        },
        {
          ...
          value: 'url(../src/assets/images/particle-pattern--red.png) #FFFFFF',
        },
      ],
    },
    controls: {
